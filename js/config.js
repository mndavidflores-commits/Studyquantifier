...
export const blindTimer = {
  running: false, seconds: 0, interval: null, startTime: null, pendingResult: false, previousProblemaNum: 1
};

export const temarioEmbebido = [
  { id: 1, materia: 'Álgebra', etapa: 'A1', nombre: 'Ecuaciones' },
  { id: 2, materia: 'Álgebra', etapa: 'B1', nombre: 'Polinomios' }
];

export let currentTemario = [...temarioEmbebido];
export let chartTiempo, chartRadar, chartEvolucion, chartProblemas = null, chartFSRS = null;
export let materiaGraficoSeleccionada = 'Matemáticas';
export let mostrarAvg10 = true;
export let mostrarPuntosB = true;
export let appInitialized = false;
export let erroresPendientes = [];
export let errorSeleccionado = null;
export let currentProblemaNum = 1;
export let sessionActual = null;
